...
<div class="title">
        ...
        <span class="heading" style="color:#fff; text-shadow:10px 10px 10px #fff">Result's Section</span>
    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="submit" value="Delete" style="color:black; background-color:#fff;">
            </fieldset>
        </form>
        <br><br>
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="submit" value="Update" style="color:black; background-color:#fff;">
            </fieldset>
        </form>
    </div>
