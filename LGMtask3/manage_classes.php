...
<div class="title">
        ...
        <span class="heading" style="color:#fff; text-shadow:10px 10px 10px #fff">Class Section</span>
    ...
    <div class="main">
        <?php
            ...
            if (mysqli_num_rows($result) > 0) {
               echo "<table>
                <caption><a style='font-size:2rem; text-shadow:5px 5px 5px #fff;'> Manage Classes</a></caption>
                <tr><a style='color:#D5D3D9; text-decoration:none;'>
                <th>Sr no.</th>
                <th>NAME</th>
                <th>ACTION</th>
                </a></tr>";
                ...
                while($row = mysqli_fetch_array($result))
                  ...
                  {
                  echo "<tr>";
                  echo "<td><a style='color:#fff; text-decoration:none;'>$cnt</a></td>";
                  echo "<td><a style='color:#fff; text-decoration:none;'>" . $row['name'] . "</a></td>";
                  echo "<td><a href='delete-class.php?id=".$row['id']."' style='color:#D5D3D9; text-decoration:none;'><span class='fa fa-trash'></span> Remove</a></td>";
